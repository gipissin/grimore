...
Partial Class frm_emprestimo
    ...
    Private Sub InitializeComponent()
        ...
        Panel1.Controls.Add(btn_dadoscliente)
        ...
        Label11.Location = New Point(322, 365)
        ...
        txt_qtdemprestimo.Location = New Point(354, 405)
        ...
        txt_qtdestoque.Location = New Point(610, 447)
        ...
        Label10.Location = New Point(565, 405)
        ...
        btn_menu.Location = New Point(733, 8)
        ...
        ' btn_dadoscliente
        ' 
        btn_dadoscliente.BackColor = Color.MediumPurple
        btn_dadoscliente.Font = New Font("Cooper Black", 14.25F)
        btn_dadoscliente.Location = New Point(610, 298)
        btn_dadoscliente.Name = "btn_dadoscliente"
        btn_dadoscliente.Size = New Size(185, 67)
        btn_dadoscliente.TabIndex = 17
        btn_dadoscliente.Text = "Dados do clientes"
        btn_dadoscliente.UseVisualStyleBackColor = False
        ' 
        ' Panel2
        ' 
        ...
        Label8.Location = New Point(139, 2)
        Label8.Name = "Label8"
        ...
        txt_titulo.Location = New Point(73, 245)
        ...
        txt_isbn.Location = New Point(73, 324)
        ...
        ' btn_devolucao
        ' 
        btn_devolucao.BackColor = Color.MediumPurple
        btn_devolucao.Font = New Font("Cooper Black", 14.25F)
        btn_devolucao.Location = New Point(631, 203)
        btn_devolucao.Name = "btn_devolucao"
        btn_devolucao.Size = New Size(164, 68)
        btn_devolucao.TabIndex = 10
        ...
        btn_emprestimo.Location = New Point(629, 115)
        ...
        dtp_emprestimo.Location = New Point(73, 494)
        ...
        dtp_devolucao.Location = New Point(290, 494)
    ...
    Friend WithEvents btn_dadoscliente As Button
