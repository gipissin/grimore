...
Partial Class login_principal
    ...
    Private Sub InitializeComponent()
        ...
        PictureBox1.Location = New Point(104, 151)
        ...
        btn_resetsenha.Font = New Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        btn_resetsenha.LinkColor = Color.BlueViolet
        btn_resetsenha.Location = New Point(134, 375)
        btn_resetsenha.Name = "btn_resetsenha"
        btn_resetsenha.Size = New Size(151, 20)
        ...
        btn_entrar.Font = New Font("Microsoft Sans Serif", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Label3.Font = New Font("Comic Sans MS", 21.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label2.Font = New Font("Comic Sans MS", 18F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label5.Font = New Font("Comic Sans MS", 21.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label5.ForeColor = Color.White
        Label5.Location = New Point(23, 84)
        Label5.Name = "Label5"
        Label5.Size = New Size(321, 40)
        Label5.TabIndex = 26
