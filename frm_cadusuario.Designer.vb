...
Partial Class frm_cadusuario
    ...
    Private Sub InitializeComponent()
        ...
        PictureBox1.Location = New Point(111, 216)
        ...
        Label11.Font = New Font("Comic Sans MS", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label11.ForeColor = Color.Black
        Label11.Location = New Point(43, 211)
        Label11.Name = "Label11"
        Label11.Size = New Size(84, 33)
        Label11.TabIndex = 22
        Label11.Text = "Senha"
        ' 
        ' Label10
        ...
        Label10.Font = New Font("Comic Sans MS", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label10.ForeColor = Color.Black
        Label10.Location = New Point(43, 152)
        Label10.Name = "Label10"
        Label10.Size = New Size(119, 33)
        Label10.TabIndex = 21
        ...
        Label3.Font = New Font("Comic Sans MS", 21.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label3.Location = New Point(36, 21)
        Label3.Name = "Label3"
        Label3.Size = New Size(291, 40)
        Label3.TabIndex = 0
        ...
        Label8.Font = New Font("Microsoft Sans Serif", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label8.ForeColor = Color.Black
        Label8.Location = New Point(286, 410)
        Label8.Name = "Label8"
        Label8.Size = New Size(79, 29)
        Label8.TabIndex = 16
        Label8.Text = "Status"
        ' 
        ' txt_csenha
        ...
        cmb_status.Margin = New Padding(2, 2, 2, 2)
        ...
        Label7.Font = New Font("Microsoft Sans Serif", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Label6.Font = New Font("Comic Sans MS", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Label5.Font = New Font("Microsoft Sans Serif", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        btn_cadastrar.Font = New Font("Microsoft Sans Serif", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ...
        Label2.Font = New Font("Comic Sans MS", 24F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label2.ForeColor = Color.White
        Label2.Location = New Point(37, 114)
        Label2.Name = "Label2"
        Label2.Size = New Size(305, 90)
        Label2.TabIndex = 27
